...
SRC_URI="http://www.paraview.org/files/v4.0/ParaView-v4.0.1-source.tgz"
...
PVLIBDIR="$(get_libdir)/${PN}-v${MAJOR_PV}"
S="${WORKDIR}"/ParaView"-v${MAJOR_PV}.1-source"
LIBRARY_PATH="${WORKDIR}/paraview-${MAIN_PV}.0.1_build/lib"
