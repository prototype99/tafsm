...
MY_REVISION="-509-gbfaf7b82ed"

MAIN_PV=$(get_major_version)
MAJOR_PV=$(get_version_component_range 1-2)
#MY_P="ParaView-v${PV}"
MY_P="ParaView-${PV}${MY_REVISION}"

DESCRIPTION="ParaView is a powerful scientific data visualization application"
HOMEPAGE="http://www.paraview.org"
SRC_URI="https://www.paraview.org/files/nightly/${MY_P}.tar.xz"
#        https://www.paraview.org/files/nightly/ParaView-v5.6.0-445-g4444c57133.tar.xz
#        https://www.paraview.org/files/nightly/ParaView-v5.6.0-445-g4444c57133.tar.xz
#        https://www.paraview.org/files/nightly/ParaView-5.6.0-445-g4444c57133.tar.xz
RESTRICT="mirror"
